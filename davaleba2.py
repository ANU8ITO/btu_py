class BankAccount:
    ...
    def transfer_to(self, reciever, amount):
        if 0 < amount <= self.__balance and amount <= self.__withdrawal_limit:
            self.withdraw(amount)
            reciever.deposit(amount)
        elif amount > self.__withdrawal_limit:
            print(f"{self.account_holder} you Cannot transfer more than your limit of {self.__withdrawal_limit}!")
        elif amount <= 0:
            print(f"{self.account_holder} Transfer amount should be positive!")
